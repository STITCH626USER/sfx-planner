      ...
      <div className="app-shell-empty-container" data-testid="app-root">
        ...
        <div className="empty-landing-card">
          <header className="landing-header">
            ...
            <h1 className="landing-title">SFX Planner <span style={{ opacity: 0.5, fontSize: '0.6em' }}>3.1.3</span></h1>
          </header>
          ...
          <div className="landing-warning-notice">
            <div className="footer-warning-card">
              <span className="warning-text">
                ...
                Contrôle obligatoire sur UKG personnel. Données traitées localement. <span style={{opacity: 0.45, fontSize: '10px', marginLeft: '6px'}}>v3.1.3</span>
              </span>
            </div>
          </div>
        </div>
